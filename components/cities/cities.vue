  ...
  <div>
    <div class="all">
      <div class="op-area">
        ...
        <div class="two_box">
          ...
          <div class="two">
            ...
            <img :src="lock2===true?'../../assets/images/top_jiao.png':''" alt class="jiao" />
        ...
        <div class="search">
          ...
          <div class="input">
            <input v-model="value" placeholder="请输入城市中文或拼音" />
          </div>
        </div>
      </div>
      <div class="hotcity">
      ...
      <div class="pysearch">
        ...
        <!-- <div v-for="(item,index) in citylist.data.cities" :key="index" class="for">
          <div>{{}}</div>
        </div> -->
      </div>
    </div>
